...
#include "backend/kernel_compiler/gpu/nn/batch_norm3d_grad_ex_gpu_kernel.h"

namespace mindspore {
namespace kernel {
MS_REG_GPU_KERNEL_ONE(BatchNorm3DGradEx,
                      KernelAttr()
                      ...
                      BatchNorm3dGradExGpuKernel, float)
MS_REG_GPU_KERNEL_ONE(BatchNorm3DGradEx,
                      KernelAttr()
                        ...
                        .AddOutputAttr(kNumberTypeFloat32)   // dscale
                        .AddOutputAttr(kNumberTypeFloat32),  // dbias
                      BatchNorm3dGradExGpuKernel, half)
